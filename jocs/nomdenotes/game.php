...
<head>
    <title>Posa nom a la nota</title>
...
<body>
    ...
    <center>
        <div class=" w3-padding w3-animate-bottom">
            <button class="w3-btn w3-khaki w3-xxlarge" id="button0"></button>
            <button class="w3-btn w3-indigo w3-xxlarge" id="button1"></button>
            <button class="w3-btn w3-teal w3-xxlarge" id="button2"></button>
            <button class="w3-btn w3-blue w3-xxlarge" id="button3"></button>
        </div>
        <div id="tryAgain"></div>
...
<script>
        $(document).ready(function() {
                    ...
                    function chooseNotes() {
                        ...
                        var level1notes = Array('do3.jpg', 're3.jpg', 'mi3.jpg', 'fa3.jpg');
                        var level2notes = Array('do3.jpg', 're3.jpg', 'mi3.jpg', 'fa3.jpg', 'sol3.jpg', 'la3.jpg', 'si3.jpg', 'do4.jpg');
                        var level3notes = Array('do3.jpg', 're3.jpg', 'mi3.jpg', 'fa3.jpg', 'sol3.jpg', 'la3.jpg', 'si3.jpg', 'do4.jpg', 're4.jpg', 'mi4.jpg', 'fa4.jpg', 'sol4.jpg', 'la4.jpg');
                        var level4notes = Array('do3.jpg', 're3.jpg', 'mi3.jpg', 'fa3.jpg', 'sol3.jpg', 'la3.jpg', 'si3.jpg', 'do4.jpg', 're4.jpg', 'mi4.jpg', 'fa4.jpg', 'sol4.jpg', 'la4.jpg', 'fa2.jpg', 'sol2.jpg', 'la2.jpg', 'si2.jpg');

                        var levelNotes = 0;
                        if (level == 1) {
                            levelNotes = level1notes;
                        } else if (level == 2) {
                            levelNotes = level2notes;
                        } else if (level == 3) {
                            levelNotes = level3notes;
                        } else if (level == 4) {
                            levelNotes = level4notes;
                        }
                        ...
                        //console.log('randomButton is ' + randomButton);
